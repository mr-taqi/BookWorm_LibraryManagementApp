...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    ...
    let numberOfTotalBorrowedBooks = allBorrowedBooks?.filter((book) => (
      book.returnDate === null
    ));
    let numberOfTotalReturnedBooks = allBorrowedBooks?.filter((book) => (
      book.returnDate !== null
    ));
          ...
          <div className="flex flex-col-reverse lg:flex-row gap-7 flex-[4]">
            <div className="flex flex-col gap-7 flex-1">
              <div className="flex items-center gap-3 bg-white p-5 max-h-[120px] overflow-y-hidden rounded-lg transition hover:shadow-inner duration-300 w-full lg:max-w-[360px]">
                ...
                <div className="flex flex-col items-center gap-2">
                  ...
                  <p className="font-light text-sm text-gray-700">Total User Base</p>
                </div>
              </div>
              <div className="flex items-center gap-3 bg-white p-5 max-h-[120px] overflow-y-hidden rounded-lg transition hover:shadow-inner duration-300 w-full lg:max-w-[360px]">
                <span className="bg-gray-300 h-20 min-w-20 flex justify-center items-center rounded-lg">
                ...
                <div className="flex flex-col items-center gap-2">
                  ...
                  <p className="font-light text-sm text-gray-700">Total Book Count</p>
                </div>
              </div>
              <div className="flex items-center gap-3 bg-white p-5 max-h-[120px] overflow-y-hidden rounded-lg transition hover:shadow-inner duration-300 w-full lg:max-w-[360px]">
                <span className="bg-gray-300 h-20 min-w-20 flex justify-center items-center rounded-lg">
                ...
                <div className="flex flex-col items-center gap-2">
                  ...
                  <p className="font-light text-sm text-gray-700">Total Admin Count</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row flex-1 items-center justify-center">
              <div className="bg-white p-5 rounded-lg shadow-lg h-full flex flex-col justify-center items-center gap-4">
                <img src={user && user.avatar?.url} alt="user avatar" className="rounded-full w-32 h-32 object-cover" />
                <h2 className="text-xl 2xl:text-2xl font-semibold text-center">{user && user?.name}</h2>
                <p className="text-gray-600 text-sm 2xl:text-base text-center capitalize">
                  Welcome to your admin Dashboard. Here you can manage all the settings and moniter the statistics.
                </p>
              </div>
            </div>
          </div>
