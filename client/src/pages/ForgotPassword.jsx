...
const ForgotPassword = () => {
  ...
  useEffect(() => {
    if (message) {
      console.log("message after success : ", message)
  ...
  return <>
    ...
    <div className="flex flex-col justify-center md:flex-row h-screen">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center bg-white p-8 relative">
        <Link to={"/login"} className="border-2 border-black rounded-3xl font-bold py-2 px-4 w-52 fixed top-10 -left-28 hover:bg-black hover:text-white transition duration-300 text-end">Back</Link>
        <div className="w-full max-w-sm">
          <div className="flex justify-center mb-12">
            <div className="rouded-full flex justify-center items-center">
              <img src={logo} alt="logo" className="h-24 w-auto" />
            </div>
          </div>
          <h1 className="text-4xl font-medium text-center mb-5 overflow-hidden">Forgot Password.</h1>
          <p className="text-gray-800 mb-12 text-center">Please enter your email address to reset your password.</p>
