    ...
    <div className="flex flex-col justify-center md:flex-row h-screen">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center bg-white p-8 relative">
        <div className="max-w-sm w-full">
          ...
          <p className="text-center text-gray-500 mb-12">Please enter your credentials.</p>
          ...
          <form onSubmit={handleLogin}>
            ...
            <Link to={"/password/forgot"} className="font-semibold mb-12 text-black">Forgot Password?</Link>
            <div className="block md:hidden font-semibold mt-5">
              <p>
                new to our platform? <Link to={"/register"} className="text-sm text-gray-500 hover:underline">Sign Up</Link>
              </p>
            </div>
            <button type="submit" className="border-2 mt-5 border-black w-full font-semibold bg-black text-white py-2 rounded-lg hover:bg-white hover:text-black transition">LOGIN</button>
          </form>
        </div>
      </div>
