  ...
  return <>
    <div className="flex flex-col justify-center md:flex-row h-screen">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center bg-white p-8 relative">
        <Link to={"/register"} className="border-2 border-black rounded-3xl font-bold py-2 px-4 w-52 fixed top-10 -left-28 hover:bg-black hover:text-white transition duration-300 text-end">Back</Link>
        <div className="max-w-sm w-full">
          ...
          <h1 className="text-4xl font-medium text-center mb-12 overflow-hidden">Check your email for the OTP.</h1>
          <p className="text-center text-gray-500 mb-12">Please enter the OTP sent to your email.</p>
