    ...
    <div className="flex flex-col justify-center md:flex-row h-screen">
      ...
      <div className="hidden w-full md:w-1/2 bg-black text-white md:flex flex-col justify-center items-center p-8 rounded-tr-[80px] rounded-br-[80px]">
        <div className="text-center h-[376px]">
          ...
          <p className="text-gray-400 mb-12">Alredy have an accound? Sign In now.</p>
          <Link to={"/login"}
        ...
        <div className="w-full max-w-sm">
          <div className="flex justify-center mb-12">
            <div className="flex flex-col-reverse sm:flex-row items-center justify-center gap-5">
              <h3 className="font-medium text-3xl overflow-hidden">SIGN UP</h3>
              <img src={logo} alt="logo" className="h-auto w-24 object-cover" />
            </div>
          </div>
          <h3 className="text-gray-600 text-center mb-12">Please provide your information for Sign Up.</h3>
